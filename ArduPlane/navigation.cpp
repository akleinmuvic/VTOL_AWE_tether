...
void Plane::update_eight_plane()
{
    ...
    // north or south
    if (_rxaplanev * eight_in_R2.ethetaxv >= 0) { _current_quadrant = -2; }
    else { _current_quadrant = -1; }
    // east or west
    if (_rxaplanev * eight_in_R2.epsixv >= 0) { _current_quadrant = _current_quadrant + 2; }
    else { _current_quadrant = -_current_quadrant + 1; };
